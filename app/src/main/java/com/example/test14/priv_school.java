...
public class priv_school extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_priv_school);
        cardView = findViewById(R.id.mgm);
        cardView2 = findViewById(R.id.strs);
        cardView3 = findViewById(R.id.cnis);
        cardView4 = findViewById(R.id.njv);
        cardView5 = findViewById(R.id.cvk);
        ...
        backhome2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(priv_school.this, MainActivity.class);
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent secondActivity = new Intent(priv_school.this, mgm2.class);
        ...
        cardView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent secondActivity = new Intent(priv_school.this, strs2.class);
                startActivity(secondActivity);
            }
        });
        ...
        cardView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent secondActivity = new Intent(priv_school.this, cnis2.class);
                startActivity(secondActivity);
            }
        });
        cardView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent secondActivity = new Intent(priv_school.this, njv2.class);
                startActivity(secondActivity);
            }
        });
        ...
        cardView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent secondActivity = new Intent(priv_school.this, cvk2.class);
                startActivity(secondActivity);
            }
        });
